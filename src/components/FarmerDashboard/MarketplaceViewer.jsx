    ...
    Swal.fire({
      ...
      html: `
        <div class="text-left">
          ...
          <p>Vendor: ${product.vendorProfile?.businessName || 'Unknown Vendor'}</p>
          <p>Price: GHS ${product.price?.toLocaleString() || '0'}</p>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          >
            ...
            <option value="0-5000">Under GHS 5,000</option>
            <option value="5000-15000">GHS 5,000 - GHS 15,000</option>
            <option value="15000-50000">GHS 15,000 - GHS 50,000</option>
            <option value="50000-0">Above GHS 50,000</option>
          </select>
                ...
                <div className="flex-grow">
                  ...
                  {product.vendorProfile?.businessName && (
                    <p className="text-xs text-gray-500 mt-1">
                      Sold by: {product.vendorProfile.businessName}
                    </p>
                  )}
                </div>
